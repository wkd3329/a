...
<form action="./submitInquiry.jsp" method="post" onsubmit="return ck();">
        <br>
        <br>
        <br>
        <br>
 ...
 <br>
                ...
                <button class="w-100 btn btn-primary btn-lg" type="button" onclick="location.href='end.jsp'">뒤로</button>
