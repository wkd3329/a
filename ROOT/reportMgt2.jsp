...
<%
	...
	String serch = request.getParameter("serch");
        ...
        String sql_select = "SELECT * FROM REPORTS_TB where report_num=?";
...
<%
		...
		String rpId=rs.getString("reported_id");
                String mId=rs.getString("report_match_id");
...
%>
	     ...
	     <tr>
<form action="./sendReport.jsp?num=<%=num%>" method="post">
		<th colspan=6>
...
<div class="gap-4 d-sm-flex justify-content-sm-center">
     <button type="submit"   class="btn btn-primary btn-sm px-4" >저장하기</button>
</form>
        <button type="button"  onclick = "location.href = '/reportMgt.jsp'" class="btn btn-primary btn-sm px-4" >뒤로    가기</button>
         </div>
