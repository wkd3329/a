...
var jb=["군산","김제","남원","익산","전주","정읍","고창","무주","부안","순창","완주","임실","장수","진안구"];
...
<form action="./setInfo.jsp" method="post" onsubmit="return ck();">
	<br>
	<br>
	<br>
	<br>
	<div class="container">
		...
		<div class="col-md-7 col-lg-8">
			<div class="row g-3">
					...
					<input type="tel" class="form-control"  name="phone" id="phone" placeholder="010-0000-0000">
				</div>
				<br>
				<div class="col-12">
					<label for="carName" class="form-label">제조사</label>
					<select class="form-control" name="car" id="car" onchange="setCar(this)" required>
				...
				<br>
				<div class="col-12">
					<label for="userArea" class="form-label">권역</label>
