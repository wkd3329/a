...
<%
	...
	String[] arr={"서울 ","부산 ","대구 ","인천 ","광주 ","대전 ","울산 ","세종 ","경기도 ","강원도 ","충청북도 ","충청남도 ","전라북도 ","전라남도 ","경상북도 ","경상남도 ","제주도 "};
	...
	<div class="container">
		...
		<div class="col-md-7 col-lg-8">
			<div class="row g-3">
					...
					<input type="tel" class="form-control"  name="phone" id="phone" placeholder="010-0000-0000" value="<%=phone%>">
				</div>
				<br>
				<div class="col-12">
